...
public class Stlyi_shadow_dom {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//*[text()='Printed Panel Drawcord Waist Pants with Side Pocket']")).click();
	    driver.findElement(By.xpath("//a[@class='flex pr-15 pos-relt bag-link']")).click();
		//driver.quit();
