...
public class OAuthTest_code3_deserialization {
...
//https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/userinfo.email&auth_url=https://accounts.google.com/o/oauth2/v2/auth&client_id=692183103107-p0m7ent2hk7suguv4vq22hjcfhcr43pj.apps.googleusercontent.com&response_type=code&redirect_uri=https://rahulshettyacademy.com/getCourse.php
		...
		String url = "https://rahulshettyacademy.com/getCourse.php?code=4%2F0AY0e-g6Bloq4ULE8bqqAO5wpWOrEhsMLvP1lNQfg-xKlQ7ILmpfQqMpAytWz7X37pXQqPQ&scope=email+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email+openid&authuser=0&prompt=none";
		...
		List<CourseChild2_Api> ls=response.getCourses().getApi();
		
		for(int i=0;i<ls.size();i++) {
			System.out.println(ls.get(i).getCourseTitle());
			if(ls.get(i).getCourseTitle().equals("SoapUI Webservices testing")) {
				System.out.println(ls.get(i).getPrice());
			}
	...
	List<CoursesChild1_WebAutomation> web=response.getCourses().getWebAutomation();
